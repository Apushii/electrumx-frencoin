...
You **must** to be running a non-pruning frencoin daemon with::

  txindex=1
  assetindex=1

set in its configuration file.  If you have an existing installation
of frend and have not previously set this you will need to reindex
the blockchain with::
...
HDD.  Currently to around height 1,750,000 of the Frencoin blockchain the
...
Check out the code from Github::
    ...
    git clone https://github.com/Electrum-FREN-SIG/electrumx-frencoin.git
    cd electrumx
...
.. _`contrib/systemd/electrumx.service`: https://github.com/Electrum-FREN-SIG/electrumx-frencoin/blob/master/contrib/systemd/electrumx.service
...
.. _`contrib/raspberrypi3/install_electrumx.sh`: https://github.com/Electrum-FREN-SIG/electrumx-frencoin/blob/master/contrib/raspberrypi3/install_electrumx.sh
.. _`contrib/raspberrypi3/run_electrumx.sh`: https://github.com/Electrum-FREN-SIG/electrumx-frencoin/blob/master/contrib/raspberrypi3/run_electrumx.sh
