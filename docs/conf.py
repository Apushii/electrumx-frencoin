...
#
html_theme_options = {
    'description': 'Lightweight Electrum Frencoin Server in Python',
    'github_user': 'Electrum-FREN-SIG',
...
latex_documents = [
    (master_doc, 'ElectrumX.tex', 'ElectrumX Frencoin Documentation',
...
man_pages = [
    (master_doc, 'electrumx', 'ElectrumX Frencoin Documentation',
     [author], 1)
]
